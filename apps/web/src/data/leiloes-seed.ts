...
export const PLANOS: Plano[] = [
  {
    ...
    preco: 197,
    periodo: "/mês",
    tagline: "Para quem opera sozinho no mercado",
    destaque: true,
    cta: "Assinar o Profissional",
    feats: [
      "Explorar todos os lotes + filtros avançados",
      "Raio-X com IA ilimitado (resumo, score, riscos)",
      "Custo total estimado + tabela FIPE para veículos",
      "Download do PDF do edital oficial",
      "Análise do edital por IA (cláusulas e alertas)",
      "Alertas por e-mail — novo edital da sua categoria",
      "Relatório PDF com fonte e data (via Raio-X do lote)",
      "Watchlist — acompanhe os lotes que importam",
  ...
  },
  {
    ...
    feats: [
      ...
      "Multiusuário — até 8 acessos (em breve)",
      "Exportação em lote — CSV/XLSX (em breve)",
      "API de dados para integração própria (em breve)",
      "Suporte prioritário por e-mail",
      "Selo de auditoria nos relatórios (em breve)",
      "7 dias grátis — só paga depois, cancele quando quiser",
    ],
